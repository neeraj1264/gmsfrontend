  ...
  const StudentDetailsSection = () => {
    return (
      <div>
        ...
        <br />
        Date of Birth: {userDetails.dob ? new Date(userDetails.dob).toLocaleDateString('en-US', { day: 'numeric', month: 'long', year: 'numeric' }) : "Not available"} <br />
        Gender: {userDetails.gender ? userDetails.gender : "Not available"} <br />
        Phone: {userDetails.phone ? userDetails.phone : "Not available"} <br />
        Address: {userDetails.address ? userDetails.address : "Not available"}
        <br />
        <br />
        {subjectAttendance &&
          Array.isArray(subjectAttendance) &&
